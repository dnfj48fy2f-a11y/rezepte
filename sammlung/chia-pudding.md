---
titel: Chia-Pudding mit Erdbeeren
title_en: Chia Pudding with Strawberries
kategorie: fruehstueck
tags: [chia, meal-prep, vegetarisch]
portionen: 2
zeit_aktiv: 5 min
zeit_gesamt: 4 h
...
## Zubereitung
1. Chiasamen mit Milch, Vanille und Stevia verrühren.
...
### Instructions
1. Stir the chia seeds with the milk, vanilla and stevia.
2. Let set in the fridge for at least 4 hours (or overnight).
3. Serve with strawberries.

### Notes
The original only lists ingredients without quantities — all amounts and the serving count are estimates.
